...
#SBATCH --mem=32GB
#SBATCH --job-name=tutorialS2END
#SBATCH --mail-type=END
#SBATCH --mail-user=sm4511@nyu.edu
#SBATCH --output=logs/tutorial_S2END_%a_%j.out
##SBATCH --gres=gpu:1

module purge

## executable
##SRCDIR=$SCRATCH/microtrellis/S2AND/scripts
#
mainDIR=$SCRATCH/microtrellis/S2AND
cd $mainDIR
mkdir -p logs
...
singularity exec --nv \
      --overlay /scratch/sm4511/microtrellis/overlay-15GB-500K.ext3:rw \
      /scratch/work/public/singularity/cuda11.2.2-cudnn8-devel-ubuntu20.04.sif \
      bash -c "source /ext3/env.sh; python $SCRATCH/microtrellis/S2AND/scripts/run_tutorial.py"
...
## to submit(for 3 jobs): sbatch --array 0-2 submitHPC.s
